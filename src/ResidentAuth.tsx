...
export default function ResidentAuth({
  ...
  return (
    <Modal onClose={onClose} closable={!busy} label={mode === 'login' ? 'Giriş yapın' : 'Hesap oluşturun'} maxWidth={460} zIndex={50}>
        <div style={{ display: 'flex', flexDirection: 'column', gap: 4, paddingBottom: 16 }}>
          <div style={{ fontSize: 11, letterSpacing: '0.14em', textTransform: 'uppercase', color: '#7E7367' }}>Site sakini</div>
        ...
        <div style={{ fontSize: 12, color: '#7E7367', paddingTop: 16, textWrap: 'pretty' }}>
          {mode === 'login'
